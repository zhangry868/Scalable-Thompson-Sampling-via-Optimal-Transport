...
def sample_dialog_data(file_name, num_contexts, shuffle_rows=True, remove_underrepresented=False):
  
  mat = scipy.io.loadmat('./contextual_bandits/datasets/data_ubuntu.mat')
  contexts = mat['data']

  contexts = contexts[:num_contexts*10, :]
  data_context = np.reshape(contexts, [1000, 10, 513])
  rewards = data_context[:,:,-1]
  contexts = data_context[:,:,:512]
  num_actions = 10
